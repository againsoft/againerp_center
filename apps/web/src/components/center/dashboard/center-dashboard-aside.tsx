...
const quickActions = [
  { label: "Review signups", href: "/registrations", icon: UserPlus },
  { label: "Agent monitoring", href: "/monitoring", icon: Activity },
  { label: "Manage licenses", href: "/licenses", icon: KeyRound },
  { label: "Deploy update", href: "/updates", icon: RefreshCw },
];
    ...
    <div className="space-y-3">
        ...
        {pendingRegs.length === 0 ? (
          ...
          <div className="space-y-2">
            ...
            <Button asChild variant="outline" size="sm" className="w-full">
              <Link href="/registrations">Review all ({pendingRegs.length})</Link>
            </Button>
          </div>
        )}
      </div>
      ...
      <div className="rounded-lg border bg-card p-4">
        ...
        <Button asChild variant="outline" size="sm" className="mt-3 w-full">
          <Link href="/ai-access">Manage AI access</Link>
        </Button>
      </div>
