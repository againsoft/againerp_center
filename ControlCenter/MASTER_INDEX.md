...
> **Governance:** Read [../docs/AGAINERP_PLATFORM_CONSTITUTION.md](../docs/AGAINERP_PLATFORM_CONSTITUTION.md) before any ControlCenter doc  
...
| 18 | [Platform Package Architecture](./18_Platform_Package_Architecture.md) | ✅ Complete | SDK layout inside `platform/` — two-repo rule |

---

## Platform packages (implementation)

All SDKs live in [`../platform/`](../platform/) — not a separate repository.

| Package | Path |
|---------|------|
| Shared contracts | [platform/shared-contracts/](../platform/shared-contracts/) |
| Runtime SDK | [platform/runtime-sdk/](../platform/runtime-sdk/) |
| Provider Gateway | [platform/provider-gateway/](../platform/provider-gateway/) |

Migration: [docs/ARCHITECTURE_MIGRATION_REPORT.md](../docs/ARCHITECTURE_MIGRATION_REPORT.md)

Root index: [../MASTER_INDEX.md](../MASTER_INDEX.md)
